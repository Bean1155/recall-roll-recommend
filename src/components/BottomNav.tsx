    ...
    <nav className="fixed bottom-0 left-0 right-0 bg-catalog-manila border-t border-catalog-softBrown py-2 px-4 z-50">
      <div className="flex justify-around items-center">
        <Link to="/" className="flex flex-col items-center">
          <div className={`rounded-full p-1 relative ${isActive('/') ? 'bg-catalog-manila' : 'bg-transparent'}`}>
            <img 
        ...
        <Link to="/recommend" className="flex flex-col items-center">
          <div className={`rounded-full p-1 relative ${isActive('/recommend') ? 'bg-catalog-manila' : 'bg-transparent'}`}>
            <img 
        ...
        <Link to="/collections" className="flex flex-col items-center">
          <div className={`rounded-full p-1 relative ${isActive('/collections') ? 'bg-catalog-manila' : 'bg-transparent'}`}>
            <img 
        ...
        <Link to="/create/food" className="flex flex-col items-center">
          <div className={`rounded-full p-1 relative ${isActive('/create') ? 'bg-catalog-manila' : 'bg-transparent'}`}>
            <img 
