                ...
                <div className="flex items-center justify-center p-1 relative">
                  <Button asChild variant="ghost" className="flex items-center justify-center h-full w-full hover:bg-transparent">
                    <Link to="/bites" className="flex items-center justify-center relative">
                      <span className="font-script text-4xl -rotate-12 text-[#0033CC] pl-7">
                        <Search size={22} className="text-[#0033CC] absolute left-2 top-1/2 -translate-y-1/2" />
                        Browse
                      </span>
                    </Link>
                  </Button>
                ...
                <div className="flex items-center justify-center p-1">
                  <Button asChild variant="ghost" className="flex items-center justify-center h-full w-full hover:bg-transparent">
                    <Link to="/create/food" className="flex items-center justify-center relative">
                      <span className="font-script text-4xl -rotate-12 text-[#0033CC] relative">
                        <PlusCircle size={22} className="text-[#0033CC] absolute -left-5 top-1/2 -translate-y-1/2" />
                        Add New
                      </span>
                    </Link>
                  </Button>
